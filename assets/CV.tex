...
\begin{center}
    ...
    Email: \href{mailto:redekop@ucsb.edu}{redekop@ucsb.edu} \quad | \quad +1 (805) 568-8958 \\
    \href{https://scholar.google.com/citations?hl=en&user=eXBKws4AAAAJ}{Google Scholar} \quad | \quad \href{https://www.linkedin.com/in/evgeny-redekop/}{LinkedIn}
\end{center}

\section*{Research Interests}
Quantum instrumentation bridging condensed matter and quantum information; Josephson microwave microscopy; nanoSQUID-on-tip probe; spatially resolved spectroscopy of correlated and topological quantum materials; cryogenic measurement and low-noise instrumentation.

\section*{Education}
\textbf{University of California, Santa Barbara} \hfill 2021--2026 (expected)\\
Ph.D. in Physics\\
...
\textbf{Graduate Researcher, NSF Quantum Foundry} \hfill Jan 2021 -- Present\\
...
Cryogenic scanning probe microscopy; characterization tools (AFM, SEM); UHV thin-film deposition (In, Pb); Python/MATLAB for instrumentation control and data analysis; low-noise measurement system design; vacuum system assembly and debugging; nanofabrication and materials characterization.

\section*{Publications}
\begin{itemize}[leftmargin=*]
    \item W. Li*, \textbf{E. Redekop}*, C. Wang Beach*, C. Zhang*, X. Zhang, X. Liu, W. Holtzmann, C. Hu, E. Anderson, H. Park, T. Taniguchi, K. Watanabe, J.-H. Chu, L. Fu, T. Cao, D. Xiao, A. Young, X. Xu. \textit{Universal Magnetic Phases in Twisted Bilayer MoTe$_2$}, arXiv:2507.22354 (2025)
